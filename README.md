...
Throughout the process of training and evaluating the model performance, I did make manual adjustments to hyperparameters, optimizers, epochs, batch sizes, etc., but did not notice a big enough difference in performance to justify manual selection of hyperparameters, outside of what the tuner determined the best. 
...
Conflict of interest disclaimer: This project does not relate to any work or products I use within the USG, and was conducted independently from my personal work. There are no special interests that may have influenced my participation, effort, or published results while working on this project. 
